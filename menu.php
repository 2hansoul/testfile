	...
	<link href="/testfile/css/menu.css" rel="stylesheet" type="text/css">
		...
		<div id="header">
			...
			<?php if($login_session == 0) { 
				...
				<? } else if($login_session == 1 ) { ?>
							<div class="btnsWrap">
								<a href="/easy/" class="btnsFav" title="간편접속"></a>
								<a href="/qna/" class="btnsCus" title="고객센터"></a>
								<a href="/recvNumber/" class="btnsCus5" title="발신번호 등록"></a>
								<a href="/recvNumber/" class="btnsCus5" title="발신번호 등록"></a>
								<a href="http://old.skysms.co.kr/" class="btnsCus4" title="이전서비스"></a>
							</div>
							<a href="/" class="logo" title="문자천국"></a>
							<div class="sitm">
								<div class="userInfo">
									<div class="intmg">
										...
										<a href="/login/logout.php" class="btns init txts"><span class="line"></span>로그아웃</a>
									</div>
									<div class="intfil">
										<div class="inftLt">
											<div class="infli">
											...
											<div class="infli">
												...
												<a href="/event/mileage/new_mileage_giftcon.php" class="btns img mainBtns003"></a>
											</div>
										</div>
										<div class="inftRt">
											<div class="infrt">
											...
											<div class="infli">
												...
												<div class="tt">
													<span class="vtt"><span id='send_count_view'></span></span>
												</div>
