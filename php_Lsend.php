<form method="GET" action="php_send_ex_sample.php">
    <div>
	<h3>장문메시지</h3>   
    <textarea style="resize : none;"  rows="10"  cols="50"  name="sendMsg_url"  id="sendMsg_url"  onKeyup="javascript:textbyte(this,2000)" placeholder="장문" required></textarea>
    <span id="byteInfo">0</span>/2000Byte
			...
			<input type="hidden" id="sType" name="sType" value="LMS">
        <div>
